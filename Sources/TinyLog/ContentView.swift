            ...
            ToolbarItem(placement: .primaryAction) {
                HStack(spacing: 12) {
                    ...
                    Button {
                        ...
                        Image(systemName: state.isFollowing ? "arrow.down.to.line.compact" : "arrow.down.to.line")
                    }
                    .help("Toggle Follow/Tail Mode (\u{2325}T)")
                    .foregroundStyle(state.isFollowing ? .green : .primary)
                }
            }
        }
    }
